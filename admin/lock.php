...
switch( $s ){
  case "c":
	mysql_query(" UPDATE `".$table."_student_details` SET `allowed_core` = '1' WHERE `RegNo` =". $r ."  ; ");
	break ;
  case "i":
	mysql_query(" UPDATE `".$table."_student_details` SET `allowed_internship` = '1' WHERE `RegNo` =". $r ."  ; ");
	break ;	
  case "a":
	mysql_query(" UPDATE `".$table."_student_details` SET `allowed_all` = '1' WHERE `RegNo` =". $r ."  ; ");
	break ;	
  case "p":
	mysql_query(" UPDATE `".$table."_student_details` SET `allowed_pc` = '1' WHERE `RegNo` =". $r ."  ; ");
	break ;	
}

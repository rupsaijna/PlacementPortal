...
if ( $table == "be" ) {
echo "<form action=\"saveeditstudent.php\" method=\"POST\">" ;
while($row = mysql_fetch_array($result)){
	...
	echo "<tr><td><b>Reg No</b></td><td>".$row['RegNo']."<input type=\"hidden\" name=\"regno\" value=\"".$row['RegNo']."\"></td><tr>";// <td></td>
	echo "<tr><td><b>E-mail</b></td><td><input type=\"text\"name=\"email\" value=\"".$row['Email']."\"></td><tr>";// <td></td> 
	echo "<tr><td><b>Ph.No</b></td><td><input type=\"text\"name=\"phno\" value=\"".$row['Phno']."\"</td><tr>";// <td></td>
	...
	echo "<table>" ;
	echo "<tr><td><b>10</b></td><td><input type=\"text\"name=\"ten\" value=\"".$row['M10']."\"</td><tr>";// <td></td>   <td><b></b></td><td></td>
	echo "<tr><td><b>12</b></td><td><input type=\"text\"name=\"twelv\" value=\"".$row['M12']."\"</td><tr>";// <td></td>
	echo "<tr><td><b>Diploma</b></td><td><input type=\"text\"name=\"dip\" value=\"".$row['MD']."\"</td><tr>";// <td></td>
	echo "</table>" ;
	echo "</fieldset><br/>";
	...
	echo "<tr><td><b>1</b></td><td><input type=\"text\"name=\"g1\" value=\"".$row['GPA1']."\"</td></tr>";
	echo "<tr><td><b>2</b></td><td><input type=\"text\"name=\"g2\" value=\"".$row['GPA2']."\"</td></tr>";
	echo "<tr><td><b>3</b></td><td><input type=\"text\"name=\"g3\" value=\"".$row['GPA3']."\"</td></tr>";
	echo "<tr><td><b>4</b></td><td><input type=\"text\"name=\"g4\" value=\"".$row['GPA4']."\"</td></tr>";
	echo "<tr><td><b>5</b></td><td><input type=\"text\"name=\"g5\" value=\"".$row['GPA5']."\"</td></tr>";
	echo "<tr><td><b>6</b></td><td><input type=\"text\"name=\"g6\" value=\"".$row['GPA6']."\"</td></tr>";
	echo "<tr><td><b>7</b></td><td><input type=\"text\"name=\"g7\" value=\"".$row['GPA7']."\"</td></tr>";
	echo "<tr><td><b>8</b></td><td><input type=\"text\"name=\"g8\" value=\"".$row['GPA8']."\"</td></tr>";
	echo "</table>" ;
	echo "<table>" ;
	echo "<tr><td><b></b></td><td><b>CGPA</b></td><td><b>Total<br/>Backlog</b></td><td><b>Total<br/>Date Change</b></td><tr>";
	echo "<tr><td><b></b></td><td><input type=\"text\"name=\"cgpa\" value=\"".$row['CGPA']."\"</td>";
	echo "<td><input type=\"text\"name=\"tbl\" value=\"".$row['TBL']."\"</td>";
	echo "<td><input type=\"text\"name=\"tsp\" value=\"".$row['TSP']."\"</td><tr>";
	echo "</table>" ;
	echo "</fieldset><br/>";
        echo "<input type=\"submit\" value=\"Save Student Details\"></form>" ;
...
echo "<table>" ;
$result = mysql_query("SELECT `recruitments`.`CompanyName`, `recruitments`.`RecId`, `recruitments`.`Status` , `students`.`RegNo` , `students`.`rstuid` from `recruitments`, `students` where `recruitments`.`RecId` = `students`.`RecId` and `students`.`RegNo` = ". $id );
while($row = mysql_fetch_array($result)){

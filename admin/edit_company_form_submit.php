...
$query_string = "UPDATE `recruitments` SET `CompanyName`='".$_POST['company_name']."' , `Details` = '".$json_encoded_details."', `HTML` = '".$html_string."', `type` = '". $_POST['type'] ."', `notes` = '". $_POST['notes'] ."' WHERE `RecId` =". $_POST["r"] ;

//echo $query_string ;

mysql_query( $query_string );

header( 'Location: '.$location.'/admin/students.php?r='.$_POST["r"] ) ;
